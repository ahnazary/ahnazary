...
As a data engineering, I have had the opportunity to work on a variety of projects, including building data pipelines, optimizing data storage and retrieval, developing machine learning models and creating unit tests. I have also gained valuable experience working with large datasets and utilizing tools such as Python, SQL and Docker. 
